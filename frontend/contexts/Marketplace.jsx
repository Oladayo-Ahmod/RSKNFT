        ...
        try{
            ...
            if (price && nftUrl) {
                ...
                Swal.fire({
                    position: 'top-end',
                    icon: 'success',
                    text: `You have successfully listed this NFT at ${price} RBTC`,
    ...
    const SellNft = async (tokenId)=>{
        try {
            ...
            Swal.fire({
                position: 'top-end',
                icon: 'success',
                text: `You have successfully purchased this item at ${new ethers.utils.parseUnits(price,'ether')} RBTC`,
                showConfirmButton: false,
                timer: 4000
            })
