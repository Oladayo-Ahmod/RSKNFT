                                    ...
                                    <div className="nft__item s2">
                                        ...
                                        <div className="nft__item_wrap">
                                            ...
                                            <a href="07_modern-item-details.html">
                                                ...
                                                <Image src="images/items/anim-10.webp" className="lazy nft__item_preview" alt="" />
                                            </a>
                                        </div>
                                ...
                                <div className="d-item">
                                    <div className="nft__item s2">
                                        ...
                                        <div className="nft__item_wrap">
                                            ...
                                            <a href="07_modern-item-details.html">
                                                <div className="d-placeholder"></div>
                                                <Image src="images/items/static-22.jpg" className="lazy nft__item_preview" alt="" />
                                            </a>
                                        </div>
                                        <div className="nft__item_info">
                                            <a href="07_modern-item-details.html">
                                ...
                                <div className="d-item">
                                    <div className="nft__item s2">
                                        ...
                                        <div className="nft__item_wrap">
                                            ...
                                            <a href="07_modern-item-details.html">
                                                <div className="d-placeholder"></div>
                                                <Image src="images/items/static-23.jpg" className="lazy nft__item_preview" alt=""/>
                                            </a>
                                        </div>
                                        <div className="nft__item_info">
                                            <a href="07_modern-item-details.html">
                                ...
                                <div className="d-item">
                                    <div className="nft__item s2">
                                        ...
                                        <div className="nft__item_wrap">
                                            ...
                                            <a href="07_modern-item-details.html">
                                                <div className="d-placeholder"></div>
                                                <Image src="images/items/static-24.jpg" className="lazy nft__item_preview" alt="" />
                                            </a>
                                        </div>
                                        <div className="nft__item_info">
                                            <a href="07_modern-item-details.html">
                                ...
                                <div className="d-item">
                                    <div className="nft__item s2">
                                        ...
                                        <div className="nft__item_wrap">
                                            ...
                                            <a href="07_modern-item-details.html">
                                                <div className="d-placeholder"></div>
                                                <Image src="images/items/anim-9.webp" className="lazy nft__item_preview" alt="">
                                            </a>
                                        </div>
                                        <div className="nft__item_info">
                                            <a href="07_modern-item-details.html">
                                ...
                                <div className="d-item">
                                    <div className="nft__item s2">
                                        ...
                                        <div className="nft__item_wrap">
                                            ...
                                            <a href="07_modern-item-details.html">
                                                <div className="d-placeholder"></div>
                                                <Image src="images/items/static-21.jpg" className="lazy nft__item_preview" alt="">
                                            </a>
                                        </div>
                                        <div className="nft__item_info">
                                            <a href="07_modern-item-details.html">
